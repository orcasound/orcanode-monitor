...
**ORCASOUND_MAX_SILENCE_DECIBELS**: The maximum decibel level at which a stream stream might still be considered unintelligible due to silence. Default: -100

**ORCASOUND_MIN_NOISE_DECIBELS**: The minimum decibel level at which a stream stream might still be considered intelligible. Default: -110
