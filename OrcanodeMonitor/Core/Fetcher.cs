...
namespace OrcanodeMonitor.Core
{
    public class Fetcher
    {
        ...
        public static List<OrcanodeEvent> GetRecentEventsForNode(OrcanodeMonitorContext context, string id)
        {
            ...
            List<OrcanodeEvent> orcanodeEvents = events.Where(e => e.DateTimeUtc >= start).ToList();
            OrcanodeEvent? olderEvent = events.Where(e => (e.DateTimeUtc < start)).FirstOrDefault();
            if (olderEvent != null)
            {
